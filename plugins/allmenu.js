...
cmd({
    ...
    try {
        ...
        // FIX: WhatsApp limite caption yon imaj a ~1024 karaktè. Ak 59+ kòmand,
        // menu a rive pase 2500 karaktè — sa te fè sendMessage echwe epi
        // deklanche "Error while generating menu." Solisyon: voye kòm mesaj
        // tèks senp (san imaj), ki gen yon limit pi wo (~65 000 karaktè).
